  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div className="text-xl">Please log in to view invoice</div>
      </div>
    );
  }
        ...
        <nav className="p-6">
          <div className="space-y-3">
            ...
            <div className="flex items-center p-4 bg-blue-700/50 rounded-xl cursor-pointer border border-blue-600/30">
              <div className="flex items-center space-x-3">
                <div className="h-10 w-10 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-xl flex items-center justify-center">
      ...
      <div className="ml-64 flex-1">
        ...
        <div className="p-8">
          <div className="text-center">
            <div className="mx-auto h-24 w-24 bg-gradient-to-br from-yellow-500 to-amber-600 rounded-3xl shadow-2xl mb-6 flex items-center justify-center">
              <DollarSign className="h-12 w-12 text-white" />
            </div>
            <h1 className="text-4xl font-bold bg-gradient-to-r from-yellow-600 to-amber-600 bg-clip-text text-transparent mb-4">Invoice</h1>
            ...
            <div className="max-w-md mx-auto">
              <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/50 shadow-lg">
                <h3 className="text-lg font-semibold text-gray-800 mb-3">Payment Management</h3>
                <p className="text-gray-600 text-sm mb-4">Generate invoices and manage payments once you have earnings.</p>
                <button className="w-full bg-gradient-to-r from-yellow-500 to-amber-600 text-white px-6 py-3 rounded-xl font-medium hover:from-yellow-600 hover:to-amber-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                  Create Invoice
                </button>
              </div>
            </div>
